...
module.exports = {
  ...
  overrides: [
    ...
    },
    {
      ...
      rules: {
        ...
        'no-unused-expressions': 'off',
        'no-unused-vars': 'off',
        'one/no-cjs-exports': 'off',
        'one/no-ts-export-equal': 'off',
  ...
  rules: {
    ...
    // one
    'one/no-import-node-modules-by-path': 'error',
    'one/if-newline': 'error',
    'one/import-dedupe': 'error',
    'one/top-level-function': 'error',
    // 'one/prefer-inline-type-import': 'error',
  },
}